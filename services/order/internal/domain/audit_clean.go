...
// EventRepository defines the interface for event outbox operations
type EventRepository interface {
	Create(ctx context.Context, event *OrderEvent) error
	GetPendingEvents(ctx context.Context, limit int) ([]*OrderEvent, error)
	Update(ctx context.Context, event *OrderEvent) error
